...
export class ParticleSystem {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        ParticleSystemFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     */
    static new(count, width, height, max_speed, radius) {
        const ret = wasm.particlesystem_new(count, width, height, max_speed, radius);
     ...
     * @param {number} height
     * @param {number} depth
     * @param {boolean} collision_enabled
     */
    update(width, height, depth, collision_enabled) {
        wasm.particlesystem_update(this.__wbg_ptr, width, height, depth, collision_enabled);
    }
    /**
     * @returns {Particle[]}
     */
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_particle_new = function(arg0) {
